...
export const DesktopLanding = () => {
  ...
  const features = [
    { icon: Sparkles, titleKey: "landing.features.cardSystem.title", descriptionKey: "landing.features.cardSystem.description", color: "text-primary" },
    { icon: Users, titleKey: "landing.features.aiGuidance.title", descriptionKey: "landing.features.aiGuidance.description", color: "text-secondary" },
    { icon: MessageSquare, titleKey: "landing.features.groupChat.title", descriptionKey: "landing.features.groupChat.description", color: "text-accent" },
    { icon: Zap, titleKey: "landing.features.cardForging.title", descriptionKey: "landing.features.cardForging.description", color: "text-primary" },
    { icon: Trophy, titleKey: "landing.features.evaluation.title", descriptionKey: "landing.features.evaluation.description", color: "text-secondary" },
    { icon: ShoppingBag, titleKey: "landing.features.marketplace.title", descriptionKey: "landing.features.marketplace.description", color: "text-accent" }
  ];

  const howItWorks = [
    { step: 1, titleKey: "landing.howItWorks.step1.title", descriptionKey: "landing.howItWorks.step1.description", weekKey: "landing.howItWorks.step1.week", color: "primary", icon: Target },
    { step: 2, titleKey: "landing.howItWorks.step2.title", descriptionKey: "landing.howItWorks.step2.description", weekKey: "landing.howItWorks.step2.week", color: "secondary", icon: Search },
    { step: 3, titleKey: "landing.howItWorks.step3.title", descriptionKey: "landing.howItWorks.step3.description", weekKey: "landing.howItWorks.step3.week", color: "accent", icon: DollarSign }
  ];
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {[...Array(50)].map((_, i) => (
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: [0.1, 0.4, 0.1], y: [0, -20, 0] }}
